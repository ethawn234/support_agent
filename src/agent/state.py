...
class EmailClassification(BaseModel):
    ...
    needs_info: Optional[str] = Field(None, description="Empty if additional information is not required. Otherwise a description of information needed to process user request")
